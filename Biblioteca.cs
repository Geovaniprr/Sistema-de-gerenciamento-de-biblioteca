...
namespace Biblioteca_01.Apresentacao
{
    public partial class Biblioteca : Form
    {
        ...
        public void biblioteca(object Form)
        {
        ...
        private void Biblioteca_Load(object sender, EventArgs e)
        {
            ...
            // Carregar os livros no DataGridView
            CarregarLivros();
        }
        ...
        private void btnBuscar_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection cn = new SqlConnection(connectionString))
            {
                try
                {
                    ...
                    string query = "SELECT titulo, autor, editora, ano_publicacao, categoria FROM livros WHERE (titulo LIKE @pesquisarLivro OR autor LIKE @pesquisarLivro OR editora LIKE @pesquisarLivro OR ano_publicacao LIKE @pesquisarLivro OR categoria LIKE @pesquisarLivro) AND quantidade_estoque > 0";
        ...
        {
            // Limpa o campo de busca procurar.
            txtProcurar.Clear();

            // Limpar os dados fornecidos pelo DataGridView.
